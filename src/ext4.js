...
return s(n*real_block_size() ,real_block_size() ) } ,read_block_group=function(n) {;
...
return read_inode(2) } ,block_group_count=function() {;
...
return( {real_block_size:real_block_size,inodes_per_block:inodes_per_block,block_group_size:block_group_size,block_group_offset:block_group_offset,read_block:read_block,read_block_group:read_block_group,read_inode:read_inode,root:root,block_group_count:block_group_count,block_group_map:block_group_map} ) } ) .call(this) ) ;
var sb=result;
...
return this instanceof $.ext4? (function(it) {return(it.block_source=block_source) ,it} ) .call(this, (this) ) :new $.ext4(block_source) } ) ) ) ) } ) .call(this) ) } ) .call(this) } ) ;
