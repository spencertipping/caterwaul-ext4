...
return(this.superblock() ) .flat_map(function(_) {return _.root() } ) } } } ,unlocked=$.future() .finalize(null) ,componentwise_lock=function() {var table= { } ;
return function(k) {;
return function(f) {;
return table[k] = ( ( (table[k] ||unlocked) ) .flat_map(f) ) .push(function(_) {return delete table[k] } ) } } } ,superblock=function(r,w) {;
